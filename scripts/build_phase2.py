...
JSON_PATH = LIT_DIR / "literature-classic.json"
...
def generate_csv(papers):
    ...
    csv_path = LIT_DIR / "literature-classic.csv"
...
def generate_bibtex(papers):
    ...
    with open(bib_path, "w", encoding="utf-8") as f:
        f.write("% Auto-generated BibTeX from literature-classic.json\n")
...
def main():
    ...
    print("\n=== Phase 2 完成 ===")
    print(f"产出文件：")
    print(f"  literature/literature-classic.csv  — CSV 结构化索引")
    print(f"  literature/references.bib          — BibTeX 引用文件")
    print(f"  literature/reading-roadmap.md      — 阅读路线图")
